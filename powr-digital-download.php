<?php
    /**
     * @package POWr Digital Download
     * @version 1.4.006
     */
    /*
    Plugin Name: POWr Digital Download
    Plugin URI: http://www.powr.io
    Description: Sell music, videos, ebooks, and more!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4.006
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Digital Download widget/////////////////////////////////
    class Powr_Digital_Download extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_digital_download',
                             __( 'POWr Digital Download' ),
                             array( 'description' => __( 'Digital Download by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-digital-download' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Digital Download.
        </p>
        <p>
    ...
    function register_powr_digital_download() {
      register_widget( 'Powr_Digital_Download' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_digital_download' );
    //Create short codes for adding plugins anywhere:
    function powr_digital_download_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-digital-download' label='$label'></div>";
    }
    add_shortcode( 'powr-digital-download', 'powr_digital_download_shortcode' );
